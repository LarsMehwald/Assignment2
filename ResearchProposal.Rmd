...
bibliography: 
  - Citations/RpackageCitations.bib
...
Most of crime studies are based on the rational choice assumptions of legal and criminal returns and the importnace of deterrence to reduce criminal behaviours [@becker1968]. However, less has been writen about the relevance of social interactions explaining criminal behaviours. Some literature, though, has focused on the relationship between violent crimes and social capital. Lederman [@Ledermanetal2002] identified that the prevalence of trust on community members has an effect on violent crimes and that the social cohesion through participation and membership in community oranisations only impact violent crime levels depending on the typ of religious and social organisation engaged. Additionally, Hanslaimer [@hanslmaier2015mehr] showed that atruism has a general negative effect on violent crimes, but other indicators of social capital only proved to be related to other types of high impact crime and not to violent crime. Hence, we are interested in responding to the question: How do social networks and bonds in a given community determine the level of violent crime?  
Social capital can be summerised as the links, shared values, and understandings in society that enable individuals and groups to trust each other and so work as a group [@OECD]. The concept of social capital gained importnace after Robert Putnam used it to describe the anomic state of the American society at the begining of the 21st century [@putnam2001bowling]. He argued that a decrease in community linkages that once held societies together and eged [WHAT DOES EGED MEAN?] to one another, translates in a loss of social capital [@putnam2001bowling].  
...
```{r SummaryData, echo=FALSE, cache=TRUE, message=FALSE}
# message=FALSE is required, otherwise displays output at packages
# cache = TRUE is nice to the police website :) 
